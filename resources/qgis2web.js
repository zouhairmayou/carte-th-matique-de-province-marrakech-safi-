...
map.getView().fit([-1194093.033632, 3366330.451642, -602046.436087, 3935465.763809], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">carte du rencsement 2024 de la population pour la région Marrakech_Safi (by MAYOU)</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (188 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Réalisation d\'une carte chroplèthe interactive basée sur la variation de la population entre les différentes provinces de la région de Marrakech Safi selon le recensement du septembre 2024';
            }
